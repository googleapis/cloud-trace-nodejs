...
export interface Config {
   ...
   *   platform projects.
   * Note that setting `propagateTraceContextFromHeader` does not change the
   * behavior of this field, as it controls whether trace context will be
   * inherited from the incoming request.
   */
  ...
  /**
   * Whether or not to use incoming trace context headers for distributed
