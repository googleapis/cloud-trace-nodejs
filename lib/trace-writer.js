...
var defaultHeaders = {};
defaultHeaders[constants.TRACE_API_HEADER_NAME] = 'node agent ' + pjson.version;
...
TraceWriter.prototype.scheduleFlush_ = function(project) {
  this.logger_.info('Flushing: timeout');
...
TraceWriter.prototype.getProjectNumber = function(callback) {
  ...
  utils.getProjectNumber(defaultHeaders, function(err, project) {
    if (err) {
      callback(err);
      return;
    }
