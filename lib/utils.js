...
/**
 * Attempts to retrieve the project number for the current active project.
 * If the project number cannot be discovered locally from the
 * GCLOUD_PROJECT_NUM environment variable, it will attempt to retrieve
 * the number from remote metadata.
 *
